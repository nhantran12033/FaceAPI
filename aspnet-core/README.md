...
* Check the `ConnectionStrings` in `appsettings.json` files under the `FaceAPI.HttpApi.Host` and `FaceAPI.DbMigrator` projects and change it if you need.
...
```bash
dotnet dev-certs https -v -ep authserver.pfx -p 3eefc93e-5453-4229-b420-33ca5a50a43d
```

> `3eefc93e-5453-4229-b420-33ca5a50a43d` is the password of the certificate, you can change it to any password you want.
